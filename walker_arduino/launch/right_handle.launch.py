...
def generate_launch_description():
    ...
    serial_preamble_arg = DeclareLaunchArgument('serial_preamble', default_value=TextSubstitution(text= 'RL' ))
    handle_topic_name_arg = DeclareLaunchArgument('handle_topic_name', default_value=TextSubstitution(text= 'right_handle' ))
    handle_frame_id_arg = DeclareLaunchArgument('handle_frame_id', default_value=TextSubstitution(text= 'right_handle_id' ))
    ...
    port_name_arg = DeclareLaunchArgument('port_name', default_value=TextSubstitution(text= '/dev/right_handle' ))
