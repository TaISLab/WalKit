...
void DetectStepsS::delete_markers(){        
...
void DetectStepsS::publish_leg(walker_msgs::msg::StepStamped step, int sid){
        visualization_msgs::msg::MarkerArray marker_array;
...
visualization_msgs::msg::Marker DetectStepsS::get_marker(const walker_msgs::msg::StepStamped* step, int id ){       
        std::string ns = "steps";
