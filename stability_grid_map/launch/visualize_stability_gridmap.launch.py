...
def generate_launch_description():
    ...
    grid_map_demos_dir = get_package_share_directory('stability_grid_map')
    ...
    declare_visualization_config_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            grid_map_demos_dir, 'config', 'stability_grid_map.yaml'),
        description='Full path to the Gridmap visualization config file to use')
    
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(
            grid_map_demos_dir, 'config', 'stability_grid_map.rviz'),
