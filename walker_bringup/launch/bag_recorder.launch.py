...
def generate_launch_description():    
    return LaunchDescription([
        ...
        DeclareLaunchArgument('topic_list', default_value=TextSubstitution(text='/left_handle /left_wheel /odom /right_handle /right_wheel /scan_filtered /sensor/bwt901cl/Angle /sensor/bwt901cl/Imu /sensor/bwt901cl/MagneticField /sensor/bwt901cl/Temperature /tf /tf_static /detected_steps')),
