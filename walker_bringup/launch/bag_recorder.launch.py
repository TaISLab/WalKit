...
def generate_launch_description():    
    return LaunchDescription([
        ...
        DeclareLaunchArgument('topic_list', default_value=TextSubstitution(text='/image_raw /left_handle /odom /left_wheel /right_wheel /right_handle /scan_filtered /sensor/bwt901cl/Angle /sensor/bwt901cl/Imu /sensor/bwt901cl/MagneticField /sensor/bwt901cl/Temperature /tf /tf_static /detected_step_left /detected_step_right /left_loads /right_loads /user_desc /handle_height')),  # /clock /odom_lscm  
